...
<%@ page import="Dao.PropertyHotDao" %>
<%@ page import="Entity.PropertyHot" %>
...
<%
    // Lấy danh sách các sản phẩm hot
    PropertyHotDao propertyHotDao = new PropertyHotDao();
    List<PropertyHot> hotProperties = propertyHotDao.getHotProperties();
%>

<div class="container1">
    <div class="left-content">
        <p class="breadcrumbs">Tin nhà đất hot</p>
        <h1>Sản phẩm bất động sản được đánh giá cao</h1>
        <p>Hiện có <strong><%= hotProperties.size() %>
        </strong> sản phẩm hot.</p>
    </div>
</div>
...
<div class="main">
    <div class="property-list">
        <%
            // Kiểm tra xem danh sách sản phẩm hot có tồn tại và không rỗng
            if (hotProperties != null && !hotProperties.isEmpty()) {
                for (PropertyHot property : hotProperties) {
        %>
        <style>
            .property-link:hover {
                opacity: 0.8;
        ...
        <a href="property-detail.jsp?id=<%= property.getPropertyId() %>" class="property-link"
                ...
                <div class="property-container">
                    ...
                    <div class="property-details">
                        ...
                        <p class="property-price">
                            <i class="fas fa-dollar-sign"></i> <%= property.getPrice() %> <%= property.getStatus() == 2 ? "triệu" : "tỷ" %>
                        ...
                        <!-- Số lượng đánh giá -->
                        <p class="property-reviews">
                            <i class="fas fa-star"></i> <%= property.getReviewCount() %> Đánh giá
                        </p>
                    </div>
                </div>
            </div>
        ...
        %>
        <p>Không có bất động sản hot hiện tại.</p>
        <%
            }
        %>
    </div>
