...
<%
    ...
    // Fetch properties where the status is "1" (indicating available properties)
...
<div class="container1">
    <div class="left-content">
        ...
        <p>Hiện có <strong><%= propertyDAO.countPropertiesByStatus("1") %> </strong> bất động sản đang có sẵn.</p> <!-- Count properties with status "1" -->
    </div>
</div>
...
<div class="main">
    <div class="property-list">
        <%
            ...
            if (properties != null && !properties.isEmpty()) {
                ...
                for (Property1 property : properties) {
                    // Only show properties where available == 1
                    if (property.getAvailable() == 1) { // Check if the property is available
        %>
        <style>
            .property-link:hover {
                opacity: 0.8;
        ...
        <%
                } // End of available check
            } // End of for loop
        } else {
        %>
        <p>Không có bất động sản nào đang được bán.</p> <!-- No properties available message -->
        <%
            }
        %>
    </div>
...
<div class="filter-container">
    ...
    <form id="priceFilterForm" method="GET" action="filter">
...
<div class="filter-container1">
    ...
    <form id="areaFilterForm" method="GET" action="filter">
        <div class="form-group">
